"""
Django settings for nugitechsite project.
...
ALLOWED_HOSTS = ["capstone-aws.mansuf-cf.my.id", "127.0.0.1", "localhost"]
...
ROOT_URLCONF = "nugitechsite.urls"
...
WSGI_APPLICATION = "nugitechsite.wsgi.application"
